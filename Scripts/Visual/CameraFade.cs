...
public class CameraFade : MonoHelper
{
	...
	/// Fade duration.
	/// </param>
	public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, bool destroyAfter, float fadeDuration)
	{
		if (isFading)
		{
			instance.DoneFading();
	...
	/// Fade delay.
	/// </param>
	public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, bool destroyAfter, float fadeDuration, float fadeDelay)
	{
		if (isFading)
		{
			instance.DoneFading();
	...
	/// </param>
	public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, bool destroyAfter, float fadeDuration, float fadeDelay, Action OnFadeFinish)
	{
		if (isFading)
		{
			instance.DoneFading();
